...
public class WwiseUEPlatform_2022_1_HoloLens : WwiseUEPlatform
{
	public WwiseUEPlatform_2022_1_HoloLens(ReadOnlyTargetRules in_TargetRules, string in_ThirdPartyFolder) : base(in_TargetRules, in_ThirdPartyFolder) {}
