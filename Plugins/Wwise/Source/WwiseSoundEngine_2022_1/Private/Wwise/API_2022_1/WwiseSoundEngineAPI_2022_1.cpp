...
{
	SCOPED_WWISESOUNDENGINE_EVENT(TEXT("FWwiseSoundEngineAPI_2022_1::Init"));
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI_2022_1);
...
{
	SCOPED_WWISESOUNDENGINE_EVENT(TEXT("FWwiseSoundEngineAPI_2022_1::Term"));
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI_2022_1);
	AK::SoundEngine::Term();
}
...
{
	SCOPED_WWISESOUNDENGINE_EVENT(TEXT("FWwiseSoundEngineAPI_2022_1::PostEvent"));
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI_2022_1);
...
AKRESULT FWwiseSoundEngineAPI_2022_1::UnsetMedia(
	AkSourceSettings* in_pSourceSettings,
	AkUInt32			in_uNumSourceSettings
)
{
...
AKRESULT FWwiseSoundEngineAPI_2022_1::SetMixer(
	AkUniqueID in_audioNodeID,
	AkUniqueID in_shareSetID
)
{
