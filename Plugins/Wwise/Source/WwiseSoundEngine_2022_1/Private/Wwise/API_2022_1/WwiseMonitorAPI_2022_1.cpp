...
AkWAAPIErrorMessageTranslator FWwiseMonitorAPI_2022_1::WaapiErrorMessageTranslator;
#endif
...
void FWwiseMonitorAPI_2022_1::SetupDefaultWAAPIErrorTranslator(const FString& WaapiIP, AkUInt32 WaapiPort, AkUInt32 Timeout)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI_2022_1);
#if AK_SUPPORT_WAAPI && WITH_EDITORONLY_DATA && !defined(AK_OPTIMIZED)
...
void FWwiseMonitorAPI_2022_1::TerminateDefaultWAAPIErrorTranslator()
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI_2022_1);
#if AK_SUPPORT_WAAPI && WITH_EDITORONLY_DATA && !defined(AK_OPTIMIZED)
