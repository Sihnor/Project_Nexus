...
public class WwiseUEPlatform_2022_1_Stadia : WwiseUEPlatform
{
	public WwiseUEPlatform_2022_1_Stadia(ReadOnlyTargetRules in_TargetRules, string in_ThirdPartyFolder) : base(in_TargetRules, in_ThirdPartyFolder) {}
	...
	public override string AkPlatformLibDir { get { return "GGP"; } }
...
public class WwiseUEPlatform_2022_1_Quail : WwiseUEPlatform_2022_1_Stadia 
{
	public WwiseUEPlatform_2022_1_Quail(ReadOnlyTargetRules in_TargetRules, string in_ThirdPartyFolder) : base(in_TargetRules, in_ThirdPartyFolder) {}
}