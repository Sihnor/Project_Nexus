...
#if AK_SUPPORT_WAAPI
class WWISESOUNDENGINE_API FWAAPI_2022_1 : public IWAAPI
{
public:
	UE_NONCOPYABLE(FWAAPI_2022_1);
	FWAAPI_2022_1() = default;
	~FWAAPI_2022_1() override {}

	class WWISESOUNDENGINE_API Client_2022_1 : public Client
	{
	public:
		UE_NONCOPYABLE(Client_2022_1);
