...
#include "Wwise/API/Platforms/HoloLensAPI.h"

#if defined(PLATFORM_HOLOLENS) && PLATFORM_HOLOLENS

class FWwisePlatformAPI_2022_1_HoloLens : public IWwisePlatformAPI
{
public:
	UE_NONCOPYABLE(FWwisePlatformAPI_2022_1_HoloLens);
	FWwisePlatformAPI_2022_1_HoloLens() = default;
	virtual ~FWwisePlatformAPI_2022_1_HoloLens() override {}
	...
	//virtual AkDeviceID GetDeviceIDFromGamepad(Windows::Gaming::Input::Gamepad^ rGamepad) override;
};

using FWwisePlatformAPI = FWwisePlatformAPI_2022_1_HoloLens;
