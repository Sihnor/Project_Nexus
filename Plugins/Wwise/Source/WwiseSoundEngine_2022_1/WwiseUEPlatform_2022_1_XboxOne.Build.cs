...
public class WwiseUEPlatform_2022_1_XboxOne : WwiseUEPlatform
{
	public WwiseUEPlatform_2022_1_XboxOne(ReadOnlyTargetRules in_TargetRules, string in_ThirdPartyFolder) : base(in_TargetRules, in_ThirdPartyFolder) {}
